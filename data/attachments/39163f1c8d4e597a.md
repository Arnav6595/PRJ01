...
- Name: 07b-invoices-details.spec.js >> Service 08B — Invoices & Account Management (Details & PDF) >> TC_08_09 — Every invoice row has a visible "Details" button
- Location: tests/07b-invoices-details.spec.js:19:9
