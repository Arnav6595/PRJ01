...
- Name: 07b-invoices-details.spec.js >> Service 08B — Invoices & Account Management (Details & PDF) >> TC_08_14 — "Download PDF" button displays the correct label text
- Location: tests/07b-invoices-details.spec.js:53:9
