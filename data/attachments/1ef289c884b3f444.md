...
- Name: 07b-invoices-details.spec.js >> Service 08B — Invoices & Account Management (Details & PDF) >> TC_08_13 — "Download PDF" button is visible on the invoice detail page
- Location: tests/07b-invoices-details.spec.js:47:9
